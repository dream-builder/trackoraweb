    ...
    <div class="login-box">
        <div class="card card-outline card-primary">
            <div class="card-header" style="text-align: center">
                ...
                {{-- <h1 class="mb-0">School Bus Tracker</h1> --}}
                <a href="/"><img src="images/trackora_logo_s.png"
                        style="width: 30%; display:inline-block; border-radius:5px;"></a>
                    ...
                    <div class="row" style="margin-top: 30px;">
                        ...
                        <div class="col-4">
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-outline-primary">{{ __('login.Sign In') }}</button>
                            </div>
                        </div>
                        <!-- /.col -->
                    </div>
