                                ...
                                <div class="card-body">
                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg">
                                            ...
                                            <!-- /.direct-chat-infos -->
                                            <img class="direct-chat-img" src="adminlte3/assets/img/user1-128x128.jpg"
                                        ...
                                        <div class="direct-chat-msg end">
                                            ...
                                            <!-- /.direct-chat-infos -->
                                            <img class="direct-chat-img" src="adminlte3/assets/img/user3-128x128.jpg"
                                                alt="message user image" />
                                            <!-- /.direct-chat-img -->
                                    ...
                                    <div class="direct-chat-contacts">
                                        <ul class="contacts-list">
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="adminlte3/assets/img/user1-128x128.jpg" alt="User Avatar" />
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="adminlte3/assets/img/user7-128x128.jpg" alt="User Avatar" />
                                                    <div class="contacts-list-info">
                                                        <span class="contacts-list-name">
                                                            Sarah Doe
                                                            <small class="contacts-list-date float-end">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="adminlte3/assets/img/user3-128x128.jpg" alt="User Avatar" />
                                                    <div class="contacts-list-info">
                                                        <span class="contacts-list-name">
                                                            Nadia Jolie
                                                            <small class="contacts-list-date float-end">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="adminlte3/assets/img/user5-128x128.jpg" alt="User Avatar" />
                                                    <div class="contacts-list-info">
                                                        <span class="contacts-list-name">
                                                            Nora S. Vans
                                                            <small class="contacts-list-date float-end">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="adminlte3/assets/img/user6-128x128.jpg" alt="User Avatar" />
                                                    <div class="contacts-list-info">
                                                        <span class="contacts-list-name">
                                                            John K.
                                                            <small class="contacts-list-date float-end">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="adminlte3/assets/img/user8-128x128.jpg" alt="User Avatar" />
                                                    <div class="contacts-list-info">
                                                        <span class="contacts-list-name">
                                                            Kenneth M.
                                                            <small class="contacts-list-date float-end">
                                    ...
                                    <div class="row text-center m-1">
                                        <div class="col-3 p-2">
                                            <img class="img-fluid rounded-circle"
                                                src="adminlte3/assets/img/user1-128x128.jpg" alt="User Image" />
                                        ...
                                        <div class="col-3 p-2">
                                            <img class="img-fluid rounded-circle"
                                                src="adminlte3/assets/img/user7-128x128.jpg" alt="User Image" />
                                            <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0"
                                                href="#">
                                                Jane
                                            </a>
                                        ...
                                        <div class="col-3 p-2">
                                            <img class="img-fluid rounded-circle"
                                                src="adminlte3/assets/img/user6-128x128.jpg" alt="User Image" />
                                            <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0"
                                                href="#">
                                                John
                                            </a>
                                        ...
                                        <div class="col-3 p-2">
                                            <img class="img-fluid rounded-circle"
                                                src="adminlte3/assets/img/user2-160x160.jpg" alt="User Image" />
                                            <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0"
                                                href="#">
                                                Alexander
                                            </a>
                                        ...
                                        <div class="col-3 p-2">
                                            <img class="img-fluid rounded-circle"
                                                src="adminlte3/assets/img/user5-128x128.jpg" alt="User Image" />
                                            <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0"
                                                href="#">
                                                Sarah
                                            </a>
                                        ...
                                        <div class="col-3 p-2">
                                            <img class="img-fluid rounded-circle"
                                                src="adminlte3/assets/img/user4-128x128.jpg" alt="User Image" />
                                            <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0"
                                                href="#">
                                                Nora
                                            </a>
                                        ...
                                        <div class="col-3 p-2">
                                            <img class="img-fluid rounded-circle"
                                                src="adminlte3/assets/img/user3-128x128.jpg" alt="User Image" />
                                            <a class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0"
                                                href="#">
                                                Nadia
                                            </a>
                        ...
                        <div class="card-body p-0">
                            <div class="px-2">
                                <div class="d-flex border-top py-2 px-1">
                                    <div class="col-2">
                                        <img src="adminlte3/assets/img/default-150x150.png" alt="Product Image"
                                            class="img-size-50" />
                                    </div>
                                    <div class="col-10">
...
@section('scripts') --}}
    <script>
        ...
        let destination = {
            lat: 23.790722656369848,
            lng: 90.41451526336647
