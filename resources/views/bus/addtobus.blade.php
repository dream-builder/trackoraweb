                ...
                <div class="col-sm-6">
                    <div class="card card-info card-outline mb-4">
                        ...
                        <div class="card-header">
                            <div class="card-title">Add to bus</div>
                        </div>
                        <!--end::Header-->
                        <!--begin::Form-->
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <form action="" method="POST" id="bus-form">
                                        <label for="bus" class="form-label">Available Buses</label>
                                        <select class="form-select" id="bus" name="bus" required="">
                                            <option>Please select </option>
                                            @if (isset($buses) && count($buses) > 0)
                                                @foreach ($buses as $bus)
                                                    <option value="{{ $bus->id }}">{{ $bus->bus_name }}
                                                        [{{ $bus->route_name }}]</option>
                                                @endforeach
                                            @endif
                                        </select>
